...
const allData = [
  { date: '2026-08-09', day: 'Saturday', checkIn: '08:48', checkOut: '--', hours: 'Live', break: '0m', status: 'Present' },
  { date: '2026-08-08', day: 'Friday', checkIn: '--', checkOut: '--', hours: '--', break: '--', status: 'Leave' },
  { date: '2026-08-07', day: 'Thursday', checkIn: '08:55', checkOut: '17:58', hours: '9h 3m', break: '45m', status: 'Present' },
  { date: '2026-08-06', day: 'Wednesday', checkIn: '09:18', checkOut: '18:30', hours: '8h 12m', break: '1h', status: 'Late' },
  { date: '2026-08-05', day: 'Tuesday', checkIn: '09:02', checkOut: '18:15', hours: '8h 13m', break: '30m', status: 'Present' },
  { date: '2026-08-04', day: 'Monday', checkIn: '--', checkOut: '--', hours: '--', break: '--', status: 'Absent' },
  { date: '2026-08-03', day: 'Sunday', checkIn: '--', checkOut: '--', hours: '--', break: '--', status: 'Holiday' },
  { date: '2026-08-02', day: 'Saturday', checkIn: '--', checkOut: '--', hours: '--', break: '--', status: 'Holiday' },
  { date: '2026-08-01', day: 'Friday', checkIn: '08:50', checkOut: '18:05', hours: '8h 15m', break: '30m', status: 'Present' },
  { date: '2026-07-31', day: 'Thursday', checkIn: '09:45', checkOut: '17:40', hours: '7h 55m', break: '0m', status: 'Late' },
  { date: '2026-07-30', day: 'Wednesday', checkIn: '08:58', checkOut: '18:20', hours: '8h 22m', break: '45m', status: 'Present' },
  { date: '2026-07-29', day: 'Tuesday', checkIn: '--', checkOut: '--', hours: '--', break: '--', status: 'Leave' },
  { date: '2026-07-28', day: 'Monday', checkIn: '08:48', checkOut: '18:10', hours: '8h 22m', break: '1h', status: 'Present' },
]
...
export default function AttendanceHistoryPage() {
  ...
  const statuses = ['All', 'Present', 'Late', 'Absent', 'Leave', 'Holiday', 'Half Day']
  ...
  const summary = {
    present: allData.filter(d => d.status === 'Present').length,
    late: allData.filter(d => d.status === 'Late').length,
    absent: allData.filter(d => d.status === 'Absent').length,
    leave: allData.filter(d => d.status === 'Leave').length,
  }
