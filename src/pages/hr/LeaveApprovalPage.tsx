...
const initialLeaves: Leave[] = [
  { id: 1, name: 'Karan Patel', dept: 'Engineering', type: 'Annual Leave', start: '2026-08-12', end: '2026-08-14', days: 3, reason: 'Family function out of town', requested: '2026-08-09', status: 'Pending' },
  { id: 2, name: 'Sneha Joshi', dept: 'Marketing', type: 'Sick Leave', start: '2026-08-10', end: '2026-08-10', days: 1, reason: 'Doctor appointment and rest', requested: '2026-08-09', status: 'Pending' },
  { id: 3, name: 'Amit Singh', dept: 'Finance', type: 'Casual Leave', start: '2026-08-14', end: '2026-08-15', days: 2, reason: 'Personal work', requested: '2026-08-08', status: 'Pending' },
  { id: 4, name: 'Pooja Nair', dept: 'Engineering', type: 'Annual Leave', start: '2026-07-25', end: '2026-07-28', days: 4, reason: 'Vacation', requested: '2026-07-20', status: 'Approved' },
  { id: 5, name: 'Vikas Verma', dept: 'Operations', type: 'Emergency Leave', start: '2026-07-18', end: '2026-07-19', days: 2, reason: 'Family emergency', requested: '2026-07-18', status: 'Approved' },
  { id: 6, name: 'Rohit Kumar', dept: 'Sales', type: 'Casual Leave', start: '2026-07-10', end: '2026-07-10', days: 1, reason: 'Personal errand', requested: '2026-07-09', status: 'Rejected' },
]
...
export default function LeaveApprovalPage() {
  ...
  const update = (id: number, status: LeaveStatus) => {
