...
export default function FeatureAttendance({ setPage }: Props) {
  return (
    <div className="w-full bg-[#0A0A0A] text-white min-h-screen">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-16">
          <div className="flex-1 space-y-8 animate-fade-up">
            <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold leading-tight">
              Attendance <span className="text-[#D4AF37]">Tracking</span>
            </h1>
            <p className="text-xl text-gray-400 leading-relaxed max-w-2xl">
              Secure clock-in / clock-out with location-aware validation, giving you accurate attendance records and complete workforce visibility.
            </p>
      ...
      <section className="py-24 bg-gradient-to-t from-[#111111] to-[#0A0A0A] border-t border-[#1E1E1E] text-center">
        <div className="container mx-auto px-6 max-w-3xl">
          <h2 className="font-heading text-3xl font-bold text-white mb-6">Ready to streamline attendance?</h2>
          <button
